...
const generalHelp = block([
    ...
    '',
    'Commands are plain chat messages, not Python-style function calls.',
    'Type `!command` + a space + the content you want to send.',
    '',
    'Use `!help <command>` for detailed instructions.',
    'Examples: `!help syntax`, `!help plot`, `!help ode`.',
    '',
    '*Quick Syntax Rules*',
    ...
    '- `!grad <field> [options]`, `!lap <field> [options]`, `!div <field> [options]`, `!curl <field> [options]`',
...
const detailedHelp = {
    syntax: block([
        '*Syntax Basics*',
        '',
        'Commands are chat commands, not function calls.',
        'Use `!plot y = sin(x)`, not `!plot(y = sin(x))`.',
        '',
        'Structured commands use one main body plus labeled options.',
